<script lang="ts">
  ...
  import type { EndOfGameReport } from "$lib/end_of_game";
  ...
  let endOfGameReport: EndOfGameReport | null = null;
  ...
  onMount(async () => {
    ...
    await listen<EndOfGameReport>("end_of_game_report", (event) => {
      endOfGameReport = event.payload;
    });
