Analyze the following C# console application end_game and the lcu.cs  provided with  after analyze the following custom shaco crate library the reveal repo uses then answer the prompted question
console of C# which 
namespace end_game
{
    class Program
...
Custom Shaco crate; === C:\Users\web\Desktop\Shaco\src\utils\process_info.rs ===
use std::ops::Deref;
